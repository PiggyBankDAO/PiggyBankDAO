...
function BondPurchase({ bond, slippage, recipientAddress }: IBondPurchaseProps) {
    ...
    async function onBond() {
        ...
        if (quantity === "") {
            ...
            if (shouldProceed) {
                const trimBalance = trim(Number(trim(Number(quantity), 10)) - 1 * Math.pow(10, -10), 10);
    ...
    const displayUnits = useAvax ? "BNB" : bond.displayUnits;
            ...
            <Slide direction="left" in={true} mountOnEnter unmountOnExit {...{ timeout: 533 }}>
                <Box className="bond-data">
                    ...
                    <div className="data-row">
                        ...
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.bondQuote, 4)} PB`}</p>
                    </div>

                    <div className={`data-row`}>
                        <p className="bond-balance-title">Max You Can Buy</p>
                        <p className="price-data bond-balance-title">{isBondLoading ? <Skeleton width="100px" /> : `${trim(bond.maxBondPrice, 4)} PB`}</p>
                    </div>
                    ...
                    <div className="data-row">
                        ...
                        <p className="bond-balance-title">0.01 PB</p>
                    </div>
