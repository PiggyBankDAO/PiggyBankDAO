...
export abstract class Bond {
    ...
    public abstract getPBAmount(networkID: Networks, provider: StaticJsonRpcProvider): Promise<number>;
    public abstract getBalanceOf(networkID: Networks, pbContract: Contract): Promise<number>;
